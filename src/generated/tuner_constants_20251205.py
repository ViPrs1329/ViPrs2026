...
class TunerConstants:
    ...
    _steer_initial_configs = configs.TalonFXConfiguration().with_current_limits(
        ...
        .with_motion_magic_cruise_velocity(10) # units: rotations per second
        .with_motion_magic_acceleration(40)    # units: rotations per second squared
        .with_motion_magic_jerk(1000)          # units: rotations per second cubed
    )
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 4.572
    ...
    _front_left_encoder_offset: units.rotation = -0.21533203125
    ...
    _back_left_encoder_offset: units.rotation = -0.40869140625
    ...
    _back_right_encoder_offset: units.rotation = 0.18359375
